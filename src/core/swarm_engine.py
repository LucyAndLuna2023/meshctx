...
class SwarmEngine:
    ...
    def discover(self, peers: List[str]) -> List[SwarmMember]:
        """发现并添加对等节点
    ...
    def register(self, member: SwarmMember) -> None:
        """手动注册成员"""
    ...
    def propose(self, proposal: str, threshold: float = 0.5) -> Vote:
        """发起投票提案
    ...
    def cast_vote(self, proposal: str, member_id: str, approve: bool) -> bool:
        """成员投票
    ...
    def get_consensus(self, proposal: str) -> Dict[str, Any]:
        """获取提案共识状态
