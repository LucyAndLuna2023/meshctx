...
SAFE_BASH_COMMANDS: Set[str] = {
    ...
    "cp", "mv", "ln", "stat", "file", "tree",
    "touch", "mkdir", "rmdir",
    "tar", "gzip", "gunzip", "zip", "unzip",
    # 文本处理
    "awk", "sed", "tr", "cut", "paste", "tee",
    "diff", "cmp", "xargs", "true", "false", "test", "[",
    "less", "more", "nl", "od", "xxd", "strings",
    # 开发工具
    ...
    "lscpu", "lsblk", "lspci", "lsusb", "dmesg",
    # 包管理
    "apt", "apt-get", "dpkg", "yum", "dnf", "rpm", "pacman",
    # Shell 内建
    "export", "source", "cd", "alias", "unalias",
    "history", "jobs", "bg", "fg", "clear", "reset",
    # 网络工具（受限）
    "ssh", "scp", "rsync",
    # 容器
    "docker", "kubectl", "helm",
    # 开发辅助
    "ldd", "ldconfig", "objdump", "readelf",
}
