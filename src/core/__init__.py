...
_known = {
    ...
    'memory_hierarchy': ['HierarchicalMemoryStore','HierarchicalMemoryItem','MemoryLevel','EbbinghausForgetting','MemoryPlugin'],
    'metacognition': ['MetaCognitionPlugin','TaskEvaluation','MetaTaskStatus','PatternEngine','BehaviorAdjuster'],
