...
_known = {
    ...
    'genomic_optimizer': ['GenomicOptimizer','Genome','MutationEngine','FitnessEvaluator','NichePreserver','GenomicOptimizerPlugin','AgentGenomeBridge','get_genomic_optimizer'],
    'epigenetic_memory': ['EpigeneticMarker','EpigeneticMemoryManager','ContextExtractor','EpigeneticMemoryBridge','compute_epigenetic_priority'],
    'crispr_cleaner': ['CRISPRCleaner','CRISPRMemoryBridge','SimilarityEngine','ContradictionDetector','MemoryWithEmbedding','CRISPRReport','DedupResult','ContradictionResult'],
