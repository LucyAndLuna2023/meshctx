...
TOKENIZER_REGISTRY: Dict[str, TokenizerInfo] = {
    ...
    "gpt-5": TokenizerInfo("o200k_base", "openai", "tiktoken", "o200k_base",
                           400_000, 0.00125, 0.01),
    "gpt-5-mini": TokenizerInfo("o200k_base", "openai", "tiktoken", "o200k_base",
                                400_000, 0.00025, 0.002),
    "gpt-5-pro": TokenizerInfo("o200k_base", "openai", "tiktoken", "o200k_base",
                               400_000, 0.0025, 0.02),
    ...
    "claude-4-opus": TokenizerInfo("claude", "anthropic", "anthropic", "claude-4",
                                   200_000, 0.015, 0.075),
    "claude-opus-4-latest": TokenizerInfo("claude", "anthropic", "anthropic", "claude-4",
                                          200_000, 0.015, 0.075),
    "claude-sonnet-4-latest": TokenizerInfo("claude", "anthropic", "anthropic", "claude-4",
                                            200_000, 0.003, 0.015),
    "claude-haiku-4-latest": TokenizerInfo("claude", "anthropic", "anthropic", "claude-4",
                                           200_000, 0.001, 0.005),
    ...
    "deepseek-v4-flash": TokenizerInfo("deepseek", "deepseek", "tiktoken_compat", "cl100k_base",
                                       128_000, 0.00027, 0.0011),
    "deepseek-v4-pro": TokenizerInfo("deepseek", "deepseek", "tiktoken_compat", "cl100k_base",
                                     128_000, 0.00055, 0.00219),
    "deepseek-v4-flash-vision-exp": TokenizerInfo("deepseek", "deepseek", "tiktoken_compat", "cl100k_base",
                                                  128_000, 0.00027, 0.0011),
    ...
    "grok-4.6": TokenizerInfo("grok", "xai", "tiktoken_compat", "cl100k_base",
                              1_000_000, 0.003, 0.015),
