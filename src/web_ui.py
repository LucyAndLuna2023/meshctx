...
# ═══════════════════════════════════════════════════════════════
# v2.16 UI REFACTOR — v2 routes moved to src/web/routes/v2.py
# Templates live in templates/*_v2.html (FileSystemLoader)
# ═══════════════════════════════════════════════════════════════
from src.web.routes.v2 import create_v2_routes
router.include_router(create_v2_routes(_render))
