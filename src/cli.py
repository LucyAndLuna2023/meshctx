...
def cmd_chat(args):
    ...
    max_turns = getattr(args, 'max_rounds', 0) or int(os.environ.get("MESHCTX_MAX_ROUNDS", "10"))
...
def main():
    ...
    c.add_argument("--max-rounds", type=int, default=0, help="搜索轮次上限 (默认10=9搜+1交付; 0则读环境变量 MESHCTX_MAX_ROUNDS)")
