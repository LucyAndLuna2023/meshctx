...
echo "=== 2/4 docs/index.html — ZH hero 13大脑区→17脑区 ==="
sed -i 's|13大脑区仿真|17脑区仿真|' docs/index.html
grep -n '大脑区仿真\|脑区仿真' docs/index.html

echo "=== 3/4 docs/getting-started.html — 全部语言 13→17 ==="
sed -i \
  -e 's|13脑区全脑仿真|17脑区全脑仿真|g' \
...
echo ""
echo "=== ✅ 修复完成。执行以下命令推送: ==="
echo "git add docs/ && git commit -m 'fix: 13→17脑区残留 (docs/download|index|getting-started|LEGAL)' && git push origin gh-pages"
