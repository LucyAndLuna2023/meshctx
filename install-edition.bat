...
REM v3.131.16: free-login guarantee - strip MESHCTX_PASSWORD residue from .env
...
REM v3.131.16: UTF-8 mode default (prevent cp936/ascii codec errors on zh-CN Windows)
