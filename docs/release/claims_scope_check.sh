...
SURFACES="docs/index.html docs/i18n/landing.json docs/download.html docs/getting-started.html docs/governance.html docs/telemetry.html docs/llms.txt templates/chat.html templates/base.html"

# ── A0 排除类 (内部/审计/历史, 逐类理由见 claims-scope §3-A0) ──
EXCLUDE='docs/marketing/claims-scope-20260905\.md|docs/release/copy-scan-[0-9].*\.txt|docs/marketing/self-evolution-verification-20260903\.md|docs/DESIGN_v1\.0\.md|docs/index\.html\.v2\.14|docs/marketing/MeshCtx_商业计划书_v3\.116\.md|docs/plans/'
