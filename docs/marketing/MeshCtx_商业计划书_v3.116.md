...
17 脑区架构：业界唯一模拟前额叶、海马体、杏仁核、默认模式网络等 17 个脑区的 Agent 系统
...
· 严格判分 EM 26/48 = 54.2%；语义判分 40/48 = 83.3% —— 对比 GPT-4o 无记忆基线 60-64%，用平价模型达到顶级模型全上下文记忆水平

【记忆基准成绩（2026-08-19 官方评测，LongMemEval 48 问）】
