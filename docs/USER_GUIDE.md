...
| 字段 | 值 |
|------|-----|
| URL | `http://你的服务器IP:3001/gateway/wechat` |
| Token | 你配置的token |
...
| 端口不对 | 防火墙/安全组未开放 | 确认端口3001在安全组中开放 |
...
# 手动启动看报错
cd /opt/meshctx
./venv/bin/python -m uvicorn src.main:app --host 0.0.0.0 --port 3001
```
