...
| **v3.124.1 (治理章节定稿里程碑)** | ✅ tag 已推 R4, CI 构建中 (R5-R7) | rc1 三方全过 (002meshctx 5a559b15 / 002codex cd24264d / 004meshctx round23) → R4 annotated tag v3.124.1 @ e3883ed4 (附回执链); 产品面超卖收敛 e3883ed4 + A2 扫描根扩展; QA 3784/59 + integrity 35; CI 三平台构建+自动 sidecar 完成后 R6/R7 收尾 |
