...
| **v3.124.1 (治理章节定稿里程碑)** | 🔄 rc1 送审中 (c0210453) | 版本整批 bump A-J + CHANGELOG; 内容=治理章节三方闭环 + 详情页 ×10 + Claims Scope 定稿 + checksum/孤儿补测; QA 3784/59 + integrity 35 + G8 node 全绿; rc1 已送三方 (42081fab/3020fa5d/4965d0f4), 回执后 R4 tag + CI 资产 |
