...
| R8.1 i18n 希伯来语全量上线 (2026-09-06) | 🔄 三方审计送审中 (e063155f) | he × 11 语言全表面: registry 1458 + landing 270 + chat 67 + base 126 + 法务 65/71 + 子页 5 + SKU (NSIS Hebrew/macOS localizations) + RTL + 文案口径 10→11; 全量 3790/59; 回执后并入下个发布 |
