...
| **v3.125.0 (治理加固)** | 🔄 rc1 送审中 (1f535839) | P1 审计链式防篡改 (bc40b65d+cb916d6e seal 修复) · P2 记忆保留段 (530e651a) · P3 scope 单一 enforce (1f535839) · P4 GET 写副作用走查 (1f535839); 全量 3790/59/0; rc1 已送三方 (02:xxZ) — 回执后 bump A-J → tag; org×plan 联动排 3.126.0 |
