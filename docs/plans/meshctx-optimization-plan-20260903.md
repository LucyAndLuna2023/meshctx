...
| **Org 组织治理 (2026-09 用户新需求)** | ✅ **并入 3.124.1 治理章节定稿 (三方闭环)** | 阶段1-4 (beb11ca8→959edad4) + 审计补丁链三方闭环 (f1eef868→7ff303f0) + R7.1 详情页 ×10 语言 (9fb30f89) + claims-scope 定稿 (9431a42e); 002meshctx 4208f9fe/2fc375eb ✅ + 002codex f9506e68 ✅ final + 004meshctx round22 ✅ — 可进入 3.124.1 发版序列 (SOP R0-R7) |
...
| 营销词 Scope 声明 (002codex 6c70eaf8) | ✅ 定稿 2026-09-05 (三方闭环) | docs/marketing/claims-scope-20260905.md + claims_scope_check.sh (A1 活跃面须 0 / A2 ⊆ §3-A0 排除附录 + HEAD 基线) — 5 轮补丁 (RTL 六页/词表全词形/BP 9 处收敛/证据闭环); 002meshctx 4208f9fe+2fc375eb ✅ / 002codex f9506e68 ✅ final / 004meshctx round21+22 ✅ — **三方全链收口**; 证据 copy-scan-20260905-claims.txt HEAD=9431a42e |
| **v3.124.1 (治理章节定稿里程碑)** | ✅ **已发版 2026-09-05 (R0-R7 闭环)** | rc1 三方全过 (5a559b15/cd24264d/round23) → tag v3.124.1 @8b546440 (重建含 linux checksum 修复 8b546440); CI 三平台+i18n 全 success; Release 24 assets = 12 二进制 + 12 .sha256 sidecar (API 删 7 杂散源码 sidecar 归位, 5/5 digest 交叉验证 MATCH); release body 已写 (383215884); linux checksum 步按 job 限定资产 db9fea8e (自 3.124.2 生效, 防杂散复发); 产品面超卖收敛 e3883ed4 + claims A2 扫描根扩展 |
| **v3.124.2** | ✅ **已发版 2026-09-06 (R0-R7 闭环)** | rc1 三方通过 (002meshctx bb4a3002 / 002codex d0035edb+e98ff895 / 004meshctx round27) → tag v3.124.2 @8ef9ca69; CI 三平台+i18n success; Release 24 = 12+12 (db9fea8e linux 限定生效; macos 同盲区修复 1dbc63c0 自 3.124.3 生效; 本版 7 杂散 API 清理, digest 5/5 MATCH); 收编 主页 f37×10/BP v3.120/海外包(001geo)/claims 证据 |
| **v3.125.0 (治理加固)** | ✅ **已发版 2026-09-06 (R0-R7 闭环)** | rc1 三方通过 (54868930/9faa2cab/round29) → tag v3.125.0 @d816ec41; CI 全 success; Release 24 = 12+12 **自动零杂散** (macos per-asset 1dbc63c0 生效, 零清理) digest 4/4 MATCH; 内容 P1 审计链/ P2 记忆保留段 / P3 scope enforce / P4 GET 走查; org×plan 联动与 P-项 (seal 外部锚定/RESERVED 集中) 排 3.126.0 |
| **v3.126.0 (he 全量上线 + org×plan caps)** | ✅ **已发版 2026-09-06 (R0-R7 闭环)** | rc1 三方通过 (571557b1/f2639cf5/round34) → tag v3.126.0 @46395c84; CI 全 success; Release 24=12+12 自动零杂散; he 11 语言全表面 + org env caps (MESHCTX_ORG_MAX_*) + 服务端 dir-he; body 已写 |
| **v3.127.0 (seal 外部锚定/保留段集中/chat 吸底)** | ✅ **已发版 2026-09-06 (R0-R7)** | rc1 三方通过 (74f5df4f/72372a1a/round36) → tag v3.127.0 @d57af18c; CI 全 success; Release 24=12+12 自动零杂散; body 已写 |
| **v3.128.0 (seal 自愈 + 手动添加任意模型)** | ✅ **已发版 2026-09-08 (R0-R7 闭环)** | rc1 三方通过 (49d9086c/665d1606/round39) → tag v3.128.0 @a0470789; CI 全 success; Release 24=12+12 自动零杂散; body 已写; 海外包已追 v3.128 块 |
| **v3.129.0 (产品优化批)** | ✅ **已发版 2026-09-09 (R0-R7 闭环)** | encoding×166/perf_counter×177/async×5+7/_known 映射/web3 修复 + P3-B 测试修复 40/40; 三平台交叉审计 (002 Py3.12/004 Py3.14/优化方 Win); Release 24=12+12 零杂散; body 已写 |
| **v3.128.0 (seal 自愈 + 手动添加任意模型)** | 🔄 rc1 送审中 (a0470789) | org seal mixed-version 自愈 (mtime) + chat ➕ 手动添加任意模型 (key 回退 provider_config) + zhipu builtin 5→16 款; QA 3812/59; rc1 已送 — 回执后 tag → CI |
| **v3.129.0 (产品优化批)** | ✅ **已发版 2026-09-09 (R0-R7 闭环)** | encoding×166/perf_counter×177/async×5+7/_known 映射/web3 修复 + P3-B 测试修复 40/40; 三平台交叉审计 (002 Py3.12/004 Py3.14/优化方 Win); Release 24=12+12 零杂散; body 已写 |
| R8.1 i18n 希伯来语全量上线 (2026-09-06) | ✅ **三方收口放行 (f3c9e10c)** | he × 11 语言全表面: registry 1458 + landing 270 + chat 66 + base 126 + 法务 65/71 + 子页 5 + SKU (NSIS Hebrew/macOS localizations) + RTL; 审计 5 轮 P2×5 全修 (zh/ru 安装器数/chat keyset+de 值/LEGAL opt_ru/注释) + test_hebrew_i18n 8 回归; 002codex b5a1d915 + 002meshctx 2538089f + 004 round30-33 收口 — **he 可上线, 并入 3.126.0/按需小发**; P3 遗留: nsi 注释已清, 服务端首屏 dir he (3.126) |
| R7.2 主页/内容联动 (2026-09-05) | ✅ | 主页 f37 Org Governance 卡 ×10 (a5f7f041) · BP v3.120 (E盘 md+docx+仓库) · 海外发布包 09-05 更新 (9 草稿+00 头+版本 bump, 已派 001geo meshctx_publish_v31241) · E 盘同步完成 |
