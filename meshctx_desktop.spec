...
_here = os.path.dirname(os.path.abspath(SPECPATH))
block_cipher = None
...
a = Analysis(
    ...
    hiddenimports=collect_submodules('src.core') + collect_submodules('src') + [
        ...
        'src.core.acp_bridge',
        'src.core.auth_v2',
        'src.core.autonomous_health',
        'src.core.backup_manager',
        'src.core.brain_monitor',
        'src.core.config_chain',
        'src.core.context_portal',
        'src.core.cost_router',
        'src.core.dual_session',
        'src.core.git_ops',
        'src.core.ha_bridge',
        'src.core.hermes_connector',
        'src.core.identity_guard',
        'src.core.memory_v5',
        'src.core.observer',
        'src.core.plugin_manager',
        'src.core.pr_agent',
        'src.core.prompt_registry',
        'src.core.proxy',
        'src.core.refactor_agent',
        'src.core.sdm_memory',
        'src.core.subagent_isolated',
        'src.core.test_generator',
        'src.core.thinking_pad',
        'src.core.token_saver',
        'src.core.tool_repair',
        'src.core.tui_format',
        # Common deps
...
if sys.platform == 'darwin':
    app = BUNDLE(exe, name='meshctx-desktop.app', icon='logo.icns',
        ...
        info_plist={
            ...
            'CFBundleShortVersionString': '3.115.16',
            'CFBundleVersion': '3.115.16',
        }, version='version_info.txt')
